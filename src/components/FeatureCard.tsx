...
const FeatureCard: React.FC<FeatureCardProps> = ({ 
  ...
  return (
    <Link 
      ...
      className={cn(
        "block bg-white p-8 rounded-lg shadow-lg text-center card-hover transform transition-all duration-300",
        className
      )}
    >
      ...
      <div className="mt-4 text-gym-purple text-sm font-medium">
        Learn More →
      </div>
    </Link>
  );
